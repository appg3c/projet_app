...
<br><br>
		<h2> <?php include ('nompiece4.php'); ?> </h2>		
<body>		
<p>	<fieldset>
<div class='fen1'><form action="donneescapteurs4.php" method="POST">

<label for "Température"> <strong>Température :</strong></label></br><br>
	    <input type="number" name="temperature" min="18" max="30" step="0.5"value=<?php include ('valeurs4.php'); ?>> °C </br>
