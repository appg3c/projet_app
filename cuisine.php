...
<br><br>
	<h2> <?php include ('nompiece1.php'); ?> </h2>		
<body>		
<p>	<fieldset>
<div class='fen1'><form action="donneescapteurs1.php" method="POST"></br>
<label for "Température"> <strong>Température :</strong></label></br>
	    <input type="number" name="temperature" min="18" max="30" step="0.5" value=<?php include ('valeurs1.php'); ?>> °C </br>
...
<?php
    if ($_SESSION['nbrelampe1'] == 1 ){
		...
		echo "</br>Pas de lampe dans cette piece";
	} 
?>	
</p></fieldset><br>
<fieldset>
...
<strong> Intérieur :</strong> <z>Bonne</z> </br>
		...
		elseif ($_SESSION['nbrefen1'] == 2) {
			echo'</BR> Etat Actuel de la fenetre1:';
		 include ("fen1.php");
